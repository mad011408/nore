...
async function configureConvexDashboard(convexServiceRoleKey: string) {
  console.log(`\n${chalk.bold("Configure Convex Dashboard")}`);
  console.log(
    "Please add the following environment variable to your Convex Dashboard:",
  );
  console.log("\n1. Go to: https://dashboard.convex.dev/");
  console.log("2. Select your project");
  console.log("3. Go to Settings → Environment Variables");
  console.log("4. Add the following variable:\n");
  console.log(chalk.bold(`   CONVEX_SERVICE_ROLE_KEY=${convexServiceRoleKey}`));
  console.log("\nThis is required for service operations.");
  return await question(
    "Hit enter after you have added the environment variable to Convex Dashboard",
  );
}
...
# Add this to Convex Dashboard → Environment Variables
...
# If using S3, also add these to Convex Dashboard → Environment Variables
...
async function setupConvex(): Promise<{
  ...
  console.log(
    "Convex provides the real-time database backend",
  );
...
async function main() {
  ...
  await configureConvexDashboard(CONVEX_SERVICE_ROLE_KEY);
