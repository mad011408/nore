...
export const MAX_TOKENS_FREE = 90000;
export const MAX_TOKENS_PRO_AND_TEAM = 90000;
export const MAX_TOKENS_ULTRA = 90000;
/**
 * Maximum total tokens allowed across all files
 */
export const MAX_TOKENS_FILE = 90000;
...
export const STREAM_MAX_TOKENS = 90000;
export const TOOL_DEFAULT_MAX_TOKENS = 90000;
...
export const truncateMessagesToTokenLimit = (
  ...
  for (let i = messages.length - 1; i >= 0; i--) {
    ...
    // Always include at least the newest message even if over limit
    if (totalTokens + messageTokens > maxTokens && result.length > 0) break;
