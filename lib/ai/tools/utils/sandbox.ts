...
const BASH_SANDBOX_TIMEOUT = 1600 * 1000; // 1600 seconds connection timeout
const BASH_SANDBOX_AUTOPAUSE_TIMEOUT = 1600 * 1000; // 1600 seconds auto-pause inactivity timeout
